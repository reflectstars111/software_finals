...
class DataSeederTest {
    ...
    void seedsCompleteReadableSampleContentForQuestionsRulesAndRecommendations() {
        ...
        verify(items, times(150)).save(itemCaptor.capture());
        ...
        assertThat(seededItems).filteredOn(item -> item.getScene() == SceneType.FOOD).hasSize(30);
        assertThat(seededItems).filteredOn(item -> item.getScene() == SceneType.TRAVEL).hasSize(30);
        assertThat(seededItems).filteredOn(item -> item.getScene() == SceneType.SOCIAL).hasSize(30);
        assertThat(seededItems).filteredOn(item -> item.getScene() == SceneType.OUTFIT).hasSize(30);
        assertThat(seededItems).filteredOn(item -> item.getScene() == SceneType.CAREER).hasSize(30);
    ...
    void refreshesLegacySampleSeedWhenOldCountsAreDetected() {
        ...
        verify(items, times(150)).save(any(RecommendationItem.class));
